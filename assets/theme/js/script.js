        ...
        if (document.querySelectorAll(".mbr-arrow-up").length) {
            ...
            window.addEventListener("scroll", function() {
                (document.documentElement.scrollTop || document.body.scrollTop) > Math.max(document.body.scrollHeight, document.documentElement.scrollHeight, document.body.offsetHeight,
                    document.documentElement.offsetHeight, document.body.clientHeight, document.documentElement.clientHeight) / 2 - document.documentElement.clientHeight / 2 || window.scrollY > window.innerHeight ? t(a) : n(a)
            });
        ...
        if (!m) {
            var a = function(a) {
                ...
                b = function(b) {
                    ...
                    k.addEventListener("click", function(b) {
                        "VIDEO" !== b.target.tagName && (d ? (-1 !== d.indexOf("youtu") && c.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}', "*"), -1 !== d.indexOf("vimeo") && e.pause()) : (b = c.parentNode.querySelector("video")) && b.pause && b.pause(), k.style.display = "none", k.removeEventListener("click", a), h.style.zIndex = "0")
                    })
                };
            document.querySelectorAll(".modalWindow-video > iframe").forEach(function(a) {
                ...
                if (b) {
                    ...
                    else if (-1 !== b.indexOf("vimeo")) a.setAttribute("src",
    ...
    m || ("undefined" === typeof window.initClientPlugin && 0 != document.body.querySelectorAll(".clients").length && (window.initClientPlugin = !0, document.body.querySelectorAll(".clients").forEach(function(a) {
        ...
        "undefined" === typeof window.initSwitchArrowPlugin && (window.initSwitchArrowPlugin = !0, k(function() {
            ...
            a.addEventListener("click", function() {
                ...
                !d.classList.contains("collapsing") || -1 == b.indexOf("toggle") && -1 == b.indexOf("accordion") || (a.classList.contains("collapsed") ? (f.classList.remove("mbri-arrow-up"), f.classList.add("mbri-arrow-down")) : (f.classList.remove("mbri-arrow-down"), f.classList.add("mbri-arrow-up")), -1 != b.indexOf("accordion") && (b = a.closest(".accordionStyles"), Array.from(b.children).filter(function(a) {
...
! function() {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.id = "top-1";
        a.style = "display: none";
        a.innerHTML = '<a href="https://mobirise.com/website-builder/kid.html">best website builder for kids</a> Mobirise v5.8.9 <a href="https://mobirise.com/drag-drop-website-builder.html">drag & drop website builder</a>';
